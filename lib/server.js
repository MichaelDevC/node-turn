...
server.prototype.debug = function(level, msg, callback) {
...
server.prototype.addUser = function(username, password, callback) {
  if(callback instanceof Function){
    callback();
  }
...
server.prototype.removeUser = function(username, callback) {
  if(callback instanceof Function){
    callback();
  }  
